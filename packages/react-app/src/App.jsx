...
import { Alert, Button, Col, Menu, Row, List, Divider, Input, Label } from "antd";
...
function App(props) {
  ...
  const initialReward = useContractReader(readContracts, "Staker", "initialReward");
  console.log("💵 Initial Reward:", initialReward);

  const exponentiation = useContractReader(readContracts, "Staker", "exponentiation");
  console.log("💵 Initial Reward:", exponentiation);
  ...
  */
  ...
  const handleChange = event => {
    ...
    console.log('amountToStake is:', event.target.value);
  };
        ...
        <Switch>
          <Route exact path="/">
            ...
            <div style={{ padding: 8, marginTop: 16 }}>
              ...
              <Balance balance={initialReward} fontSize={64} /> ETH
            </div>
            ...
            <div style={{ padding: 8, marginTop: 16 }}>
              ...
              <Balance balance={exponentiation} fontSize={64} /> ETH
            </div>
            ...
            <div style={{ padding: 8 }}>
              <Button
                type={"default"}
                onClick={() => {
                  tx(writeContracts.Staker.lockFunds());
                }}
              >
                📡 Lock Funds!
              </Button>
            ...
            <div style={{ padding: 8 }}>
              <Button
                type={"default"}
                onClick={() => {
                  tx(writeContracts.ExampleExternalContract.retrieveLockUpFunds());
                }}
              >
                📡 Unlock Funds!
              </Button>
            ...
            <div style={{ padding: 8 }}>
              ...
              value={amountToStake}
              placeholder={amountToStake}
              label="Custom amount to 🥩 Stake!" 
              style={{ width: 150 }} />
              <Button
                type={balanceStaked ? "success" : "primary"}
                onClick={() => {
                  var amountToStakeStr = amountToStake + '';
                  tx(writeContracts.Staker.stake({ value: ethers.utils.parseEther(amountToStakeStr) }));
                }}
              >
                🥩 Stake ethers!
              </Button>
